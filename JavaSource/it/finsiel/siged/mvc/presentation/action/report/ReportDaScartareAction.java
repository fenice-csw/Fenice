...
public final class ReportDaScartareAction extends Action {
    ...
    public void stampaReport(HttpServletRequest request,
        ...
        try {
            ...
            jasperDesign = JRXmlLoader.load(context.getRealPath("/") + FileConstants.STAMPA_PROTOCOLLI_DA_SCARTARE_REPORT_TEMPLATE);
            ...
            Collection<ReportProtocolloView> c = protocolliDaScartare(utente, titolarioId,
                    dataInizio, dataFine);
            // Collection c =
    ...
    private Collection<ReportProtocolloView> protocolliDaScartare(Utente utente, int titolarioId,
            Date dataInizio, Date dataFine) throws Exception {
        Collection<ReportProtocolloView> prot = new ArrayList<ReportProtocolloView>();
        ...
        try {
            for (Iterator<ReportProtocolloView> i = prot.iterator(); i.hasNext();) {
                ReportProtocolloView dest =  i.next();

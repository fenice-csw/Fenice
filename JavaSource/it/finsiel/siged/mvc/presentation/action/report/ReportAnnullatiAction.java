...
public final class ReportAnnullatiAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (request.getParameter("selezionaUfficio") != null) {
            reportForm.setUfficioCorrenteId(Integer.parseInt(request.getParameter("selezionaUfficio")));
        ...
        if (request.getParameter("assegnaUfficioAction") != null) {
            ...
            if (totalRecords > maxRighe) {
                ...
                common.put("ReportSubTitle",reportForm.getSelezionatoDescription());
                common.put("Assegnatario", String.valueOf(reportForm.getSelezionato().getUfficioId()));
    ...
    public void stampaReport(HttpServletRequest request,
        ...
        try {
            ...
            //File reportFile = new File(context.getRealPath("/") + FileConstants.STAMPA_PROTOCOLLI_ANNULLATI_REPORT_COMPILED);
            //JasperReport jasperReport = (JasperReport) JRLoader.loadObject(reportFile.getPath());
        	File reportFile = new File(context.getRealPath("/") + FileConstants.STAMPA_PROTOCOLLI_ANNULLATI_REPORT_TEMPLATE);
			//JasperDesign jasperDesign = JRXmlLoader.load(new LegacyJasperInputStream(new FileInputStream(context.getRealPath("/") + FileConstants.STAMPA_PROTOCOLLI_ANNULLATI_REPORT_TEMPLATE)));
			JasperDesign jasperDesign = JRXmlLoader.load(context.getRealPath("/") + FileConstants.STAMPA_PROTOCOLLI_ANNULLATI_REPORT_TEMPLATE);
            ...
            Collection<ReportProtocolloView> c = ReportProtocolloDelegate.getInstance().stampaProtocolliAnnullati(utente, assegnatarioId);

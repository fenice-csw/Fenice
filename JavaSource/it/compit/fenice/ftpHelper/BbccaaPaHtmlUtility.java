...
public class BbccaaPaHtmlUtility extends HtmlUtility{
	
	public BbccaaPaHtmlUtility() {
	}

	public InputStream creaListaRepertoriHTML(Collection<RepertorioVO> list) {
		if (list != null) {
			String intestazione="<html lang=\"it\"><head>";
			String page="</head><body><div class=\"row_logo\"><div class=\"pull-left\"><img src=\"testa_bca.png\"/></div><div class=\"outer-background-container\"><img src=\"laterale.png\" /></div></div>";
			page += "<div class=\"container\"><h1 class=\"title\">Albo Pretorio</h1><ul class=\"list-group\">";
			...
			return parseStringToIS(intestazione+getCharSetUtf8() + getCssLink("") + page);
		} else
			return null;
	}
	...
	public InputStream creaDocumentoRepertorioHTML(DocumentoRepertorioVO vo, int flagPubblicazione) {
		if (vo != null) {
			...
			page += "</div>"+riservato+"</div><p><a class=\"btn btn-default pull-left\" href=\"../repertorio.html\" id=\"indietro_action\" data-toggle=\"tooltip\" data-original-title=\"Torna alla lista dei Documenti\"><span class=\"glyphicon glyphicon-arrow-left\"></span> INDIETRO</a></p></div></body></html>";
			return parseStringToIS(intestazione+getCharSetUtf8() + getCssLink("../../") +getJavascriptlink("../../")+ page);
		} else
			return null;
	}

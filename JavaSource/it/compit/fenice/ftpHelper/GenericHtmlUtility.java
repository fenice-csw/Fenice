...
public class GenericHtmlUtility extends HtmlUtility{

	
	public GenericHtmlUtility() {
	}
	...
	public InputStream creaRepertorioHTML(RepertorioVO vo, int numeroDocumentoRepertorio, 
		...
		if (vo != null) {
			...
			page += "<tr><th class=\"hidden\"></th><th>Nr.</th><th>Data Documento</th><th>Oggetto</th><th>Pubblicato il</th><th>Scadenza</th></tr></thead><tbody>";
	...
	public InputStream creaAmmTrasparenteHTML(AmmTrasparenteVO vo, int numeroDocumentoAmmTrasparente, Collection<DocumentoAmmTrasparenteView> docList) {
		if (vo != null) {
			...
			page += " <div id=\"no-more-tables\" class=\"container\">";
			page += "<h1>" + vo.getDescrizione() + "</h1>";
			page += "<table id=\"sezione\" class=\"table table-bordered\"><thead>";
			page += "<tr><th class=\"hidden\"></th><th>Nr.</th><th>Data Documento</th><th>Oggetto</th><th>Pubblicato il</th><th>Scadenza</th></tr></thead><tbody>";
			for (DocumentoAmmTrasparenteView doc : docList) {
				...
				if(doc.getStato()==DocumentoRepertorioVO.PUBBLICATO || doc.getStato()==DocumentoRepertorioVO.PUBBLICATO_PROTOCOLLATO || doc.getNumeroDocumentoSezione()==numeroDocumentoAmmTrasparente)
					page += "<td><a href=\"" + doc.getDocSezioneId()+ "/doc_sezione.html\">"+ doc.getNumeroDocumentoSezione() + "</a></td>";
				else
					page += "<td>"+doc.getNumeroDocumentoSezione() + "</td>";
				if (doc.getDataDocumento() != null)
					page += "<td>"+ DateUtil.formattaData(doc.getDataDocumento().getTime()) + "</td>";
				else
					page += "<td></td>";
			...
			page += "</tbody></table>";
			page +="<div class=\"pull-left\"><p><a href=\"#\" id=\"export_action\" class=\"btn btn-default export\" data-toggle=\"tooltip\" data-original-title=\"Scarica in Open Data\">"
					+"<span class=\"glyphicon glyphicon-download\"></span>CSV</a></p><p><a href=\"../lista_sezioni.html\" id=\"indietro_action\" class=\"btn btn-default\" data-toggle=\"tooltip\" data-original-title=\"Torna alla Home\">"
					+"<span class=\"glyphicon glyphicon-arrow-left\"></span>INDIETRO</a></p><div>";
			return parseStringToIS(getCharSetUtf8() + getCssLink("../") + page);
		} else
			return null;
	...
	public InputStream creaDocumentoAmmTrasparenteHTML( DocumentoAmmTrasparenteVO vo, int flagPubblicazione) {
		if (vo != null) {
			String page = getJavascriptlink("../../");
			page += "<div class=\"container\"><div class=\"doc-sezione\"><h1>"+vo.getOggetto()+"</h1>";
			String riservato = "<span class=\"reserved\"><strong><sup>(1)</sup></strong>Non visualizzabile ai sensi del DLGS 196/2003</span>";
			page += "<p><strong>Documento Nr. </strong>"+ vo.getNumeroDocumentoSezione()+ " <strong>pubblicato il</strong> "+ DateUtil.formattaData(vo.getDataSezione().getTime()) + "</p>";
			page += "<p><strong>Pubblicabile dal</strong> "+ DateUtil.formattaData(vo.getDataValiditaInizio().getTime())+ " <strong>al</strong> "+ DateUtil.formattaData(vo.getDataValiditaFine().getTime()) + "</p>";
			page += "<p><strong>Importo: </strong>"+ ((vo.getImporto()!=null && vo.getImporto().intValue()!=0)?vo.getImporto():"/") + "</p>";
			page += "<p><strong>Descrizione: </strong> "+ (vo.getDescrizione()!=null?vo.getDescrizione():"/") + "</p>";
			page += "<div class =\"field-label\">Documenti da scaricare</div><div class =\"field-items\">";
			...
			page += "</div>"+riservato+"</div><p><a class=\"btn btn-default pull-left\" href=\"../sezione.html\" id=\"indietro_action\" data-toggle=\"tooltip\" data-original-title=\"Torna alla lista dei Documenti\"><span class=\"glyphicon glyphicon-arrow-left\"></span> INDIETRO</a></p></div>";
			return parseStringToIS(getCharSetUtf8() + getCssLink("../../") + page);
		} else
			return null;
	}
	...
	public InputStream creaListaSezioniHTML(Collection<AmmTrasparenteVO> list) {
		if (list != null) {
			...
			for (AmmTrasparenteVO vo : list) {
				page += "<li class=\"list-group-item\"><h4><a href=\"" + vo.getSezioneId()+ "/sezione.html\">" + vo.getDescrizione()+ "</a></h4></li>";
			}
			page += "</ul></div>";
			return parseStringToIS(getCharSetUtf8() + getCssLink("") + page);
		} else

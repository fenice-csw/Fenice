...
public class DocumentoAmmTrasparenteForm extends UploaderForm {
	...
	private String numeroDocumentoAmmTrasparente;
	...
	public String getNumeroDocumentoAmmTrasparente() {
		return numeroDocumentoAmmTrasparente;
	}

	public void setNumeroDocumentoAmmTrasparente(String numeroDocumentoAmmTrasparente) {
		this.numeroDocumentoAmmTrasparente = numeroDocumentoAmmTrasparente;
	}
	...
	public void setDocSezioneId(int docSezioneId) {
		this.docSezioneId = docSezioneId;
	}
	...
	public String getDataSezione() {
		return dataSezione;
	}

	public void setDataSezione(String dataSezione) {
	...
	public void allegaDocumento(DocumentoVO doc) {
		AmmTrasparenteBO.putAllegato(doc, this.documentiAllegati);
	}
	...
	public void allegaDocumentoTimbrato(DocumentoVO doc) {
		AmmTrasparenteBO.putAllegato(doc, this.documentiAllegatiTimbrati);
	}
	...
	public void inizializza() {
		this.docSezioneId = 0;
		this.numeroDocumentoAmmTrasparente=null;
	...
	public ActionErrors validate(ActionMapping mapping,
		...
		if (request.getParameter("btnConferma") != null) {
			...
			if (getNumeroDocumentoAmmTrasparente() == null || "".equals(getNumeroDocumentoAmmTrasparente().trim())) {
				errors.add("oggetto", new ActionMessage("campo.obbligatorio",
						"Numero Documento Sezione", ""));
			}
			...
			if (getNumeroDocumentoAmmTrasparente() != null && !"".equals(getNumeroDocumentoAmmTrasparente().trim()))
				if (!NumberUtil.isInteger(getNumeroDocumentoAmmTrasparente())) {
			...
			if(isPrincipale() && isDocumentoPrincipalePresent()){
				errors.add("Principale", new ActionMessage("ammtrasparente.documento.principale.esistente", "Principale"));
				setPrincipale(false);
			}
		}
		return errors;

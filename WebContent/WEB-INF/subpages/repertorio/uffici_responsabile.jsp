...
<ul>
	<li class="ufficioCorrente"><a href="javascript:document.getElementById('levelUpButton').click();"><bean:write name="repertorioForm"
	...
	<ul>
		<logic:notEmpty name="repertorioForm" property="ufficiDipendentiResponsabile">
			<logic:iterate id="ufficio" name="repertorioForm"
		...
		<%-- 
			<logic:notEmpty name="repertorioForm" property="utenti">
				<logic:iterate id="utente" name="repertorioForm" property="utenti">

...
<span class="hidden">Sezione corrente:<strong>
<bean:write name="protocolloForm" property="sezioneVisualizzata" /></strong></span>
<br class="hidden" />
...
<logic:notEmpty name="protocolloForm"
	...
	<logic:iterate id="sez" name="protocolloForm" property="elencoSezioni">
		...
		<logic:equal name="sez" property="nome" value="Titolario"><bean:define id="OR_CONDITION" value="true"/></logic:equal>

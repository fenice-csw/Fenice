...
<table summary="">
	...
	<tr>
		...
		<logic:empty name="protocolloForm"
			...
			<html:submit styleClass="button" property="allegaDocumentoPrincipaleScannOldAction" value="Allega" title="Allega il file" />
			<logic:equal name="protocolloForm" property="flagTipo" value="I">			  			
  				<a id="various3" class="button" onclick="timer_scan('allegaEdit.do?nomeFilePrincipaleUpload')"  href="<%= request.getContextPath()%>/scanagent/scanagent.jsp?jSessID=<%=request.getSession().getId()%>&url=http://<%=request.getServerName()%>:<%=request.getServerPort()%><%= request.getContextPath()%>/page/protocollo/ingresso/documento.do&nProt=<bean:write name='protocolloForm' property='numeroProtocolloScanner' />" >Scanner</a>
  			</logic:equal>
			<logic:equal name="protocolloForm" property="flagTipo" value="U">
				<a id="various3" class="button" onclick="timer_scan('allegaEdit.do?nomeFilePrincipaleUpload')"  href="<%= request.getContextPath()%>/scanagent/scanagent.jsp?jSessID=<%=request.getSession().getId()%>&url=http://<%=request.getServerName()%>:<%=request.getServerPort()%><%= request.getContextPath()%>/page/protocollo/uscita/documento.do&nProt=<bean:write name='protocolloForm' property='numeroProtocolloScanner' />" >Scanner</a>
			</logic:equal>
			<logic:equal name="protocolloForm" property="flagTipo" value="P">
					<a id="various3" class="button" onclick="timer_scan('allegaEdit.do?nomeFilePrincipaleUpload')"  href="<%= request.getContextPath()%>/scanagent/scanagent.jsp?jSessID=<%=request.getSession().getId()%>&url=http://<%=request.getServerName()%>:<%=request.getServerPort()%><%= request.getContextPath()%>/page/protocollo/posta_interna/documento.do&nProt=<bean:write name='protocolloForm' property='numeroProtocolloScanner' />" >Scanner</a>
			</logic:equal>

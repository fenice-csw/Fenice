...
<div>
	<logic:notEmpty name="scaricoForm" property="protocolliScaricoCollection">
		<display:table class="simple" width="100%" requestURI="/page/protocollo/dashboard/posta_interna_repertorio.do"
			...
			<display:column title="N. protocollo">
				<html:link  action="/page/protocollo/posta_interna/ricevute_repertorio.do" 
			...
			<display:column title="Azioni">
				[<html:link  action="/page/protocollo/posta_interna/ricevute_repertorio.do"
						paramId="btnInviaRepertorio" paramProperty="protocolloId" paramName="row">Invia a Repertorio</html:link>]
			</display:column>	
		</display:table>
	</logic:notEmpty>
</div>

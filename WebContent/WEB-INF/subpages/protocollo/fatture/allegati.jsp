...
<p>
  ...
  <logic:equal name="protocolloForm" property="flagTipo" value="I">
   		<a id="various3" class="button"  href="<%= request.getContextPath()%>/scanagent/scanagent.jsp?jSessID=<%=request.getSession().getId()%>&url=http://<%=request.getServerName()%>:<%=request.getServerPort()%><%= request.getContextPath()%>/page/fatture/documento.do?allegaDocumentoScannAction=true" >Scanner</a>
   </logic:equal>
</p>

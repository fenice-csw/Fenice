...
<ul>
	<li class="ufficioCorrente"><a href="javascript:document.getElementById('levelUpButton').click();"><bean:write name="ammTrasparenteForm"
		property="ufficioCorrenteResponsabile.nomeUfficio" /></a>
		<html:submit
	...
	<ul>
		<logic:notEmpty name="ammTrasparenteForm" property="ufficiDipendentiResponsabile">
			<logic:iterate id="ufficio" name="ammTrasparenteForm"
				property="ufficiDipendentiResponsabile">
				<li class="ufficio"><bean:write name="ufficio"
					property="nomeUfficio" />
					[<a class="treeAction" href="javascript:treeAction(<bean:write name="ufficio" property="id"/>,'assegnaUfficioButton','ufficioResponsabileSelezionatoId')">Assegna</a>] 
		...
		<%-- 
			<logic:notEmpty name="ammTrasparenteForm" property="utenti">
				<logic:iterate id="utente" name="ammTrasparenteForm" property="utenti">

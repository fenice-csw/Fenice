...
<p><logic:notEmpty property="documentiAllegatiCollection"
	...
	<logic:iterate id="recordDocumento"
		property="documentiAllegatiCollection" name="titolarioForm">
		<span> <bean:define id="idx" name="recordDocumento"
			...
			<bean:write name="idx" />
		</html:multibox> <html:link action="/page/amministrazione/titolario.do" paramId="downloadAllegatoId"
...
<logic:notEmpty name="titolarioForm"

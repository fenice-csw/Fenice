...
<ul>
	<li class="ufficioCorrente"><a href="javascript:document.getElementById('levelUpButton').click();"><bean:write name="oggettiForm"
	...
	<ul>
		<logic:notEmpty name="oggettiForm" property="ufficiDipendenti">
			<logic:iterate id="ufficio" name="oggettiForm"

...
<div>
	<logic:notEmpty name="cruscottoForm" property="protocolliCollection">
		<display:table class="simple" width="100%"requestURI="/page/cruscotto/struttura.do"
			name="sessionScope.cruscottoForm.protocolliCollection" export="false"
			...
			<display:column title="Azioni">
					...
					[<html:link action="/page/cruscotto/struttura.do"
						paramId="riassegnaProtocollo" paramProperty="protocolloId"
						paramName="row">Riassegna</html:link>]
	...
	<logic:empty name="cruscottoForm" property="protocolliCollection">
		<span><strong> Nessun protocollo in lavorazione </strong></span>
	</logic:empty></div>

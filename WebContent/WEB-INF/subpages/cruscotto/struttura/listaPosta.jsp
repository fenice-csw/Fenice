...
<div>
	...
	<logic:notEmpty name="cruscottoForm" property="postaCollection">
		<display:table class="simple" width="100%"
			requestURI="/page/cruscotto/struttura.do"
			name="sessionScope.cruscottoForm.postaCollection" export="false"
			...
			<display:column title="N. posta">
					...
					<html:link action="/page/cruscotto/struttura.do"
						paramId="postaSelezionato" paramProperty="protocolloId"
						paramName="row">
				...
				<logic:equal name="row" property="tipoMittente" value="M">
					<ul>
						<logic:iterate id="mittente" name="row" property="mittenti">
							<li><bean:write name="mittente" property="nome" /> <bean:write
								name="mittente" property="cognome" /></li>
						</logic:iterate>
					</ul>
				</logic:equal>
			</display:column>
			...
			<display:column title="Azioni">
					[<html:link action="/page/cruscotto/struttura.do"
						paramId="riassegnaPosta" paramProperty="protocolloId"
						paramName="row">Inoltra</html:link>]
			</display:column>
		</display:table>
		<p>
	...
	<logic:empty name="cruscottoForm" property="postaCollection">
		<span><strong> Nessun messaggio di posta </strong></span>
	</logic:empty></div>

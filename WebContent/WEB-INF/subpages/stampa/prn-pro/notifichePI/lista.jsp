...
<logic:notEmpty name="reportGenericForm" property="reportFormatsCollection">
<bean:message key="report.messaggio2"/>:
<br />
<ul>
<logic:iterate id="currentRecord" name="reportGenericForm" property="reportFormatsCollection" >
  <li>
  	...
  	<html:link action="/page/stampa/prn-pro/notifichePI" name="currentRecord" property="parameters" target="_blank" style="display:none"  /> 
  </li>

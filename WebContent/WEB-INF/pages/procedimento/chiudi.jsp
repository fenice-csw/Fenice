...
<eprot:page title="Chiusura Procedimento">
	...
	<span class="title"> <strong> <bean:message
		...
		<span>Vuoi chiudere il procedimento?</span>
				<html:submit styleClass="submit" property="chiusuraAction" value="Chiudi" title="Chiudi il Procedimento" />
				<html:submit styleClass="submit" property="annullaOperazioneAction" value="Annulla" title="Annulla la Chiusura " />
	</html:form>
	</div>
</eprot:page>

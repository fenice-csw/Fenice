...
<html:form action="/page/protocollo/anagrafica/listaDistribuzioneInterna/nuovo.do">
<div>

<div class="sezione">
  <span class="title"><strong><bean:message key="soggetto.giuridica.altridati"/></strong></span>
	<jsp:include page="/WEB-INF/pages/protocollo/anagrafica/listaDistribuzioneInterna/formListaDistribuzioni.jsp" />
</div>
...
<div class="sezione">
  <span class="title"><strong><bean:message key="soggetto.giuridica.soggetti"/></strong></span>
	<jsp:include page="/WEB-INF/subpages/protocollo/anagrafica/listaDistribuzioneInterna/uffici.jsp" />
</div>
</logic:greaterThan> 

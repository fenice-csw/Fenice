...
<html:form action="/page/protocollo/posta_interna/fascicolaMultiplaEdit.do" enctype="multipart/form-data">
...
<div>
	...
	<html:submit styleClass="submit" property="fascicolazioneMultiplaAction" value="Fascicola" alt="Salva protocollo" />

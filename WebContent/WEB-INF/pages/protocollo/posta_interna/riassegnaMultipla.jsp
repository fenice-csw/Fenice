...
<html:form action="/page/protocollo/posta_interna/riassegnaMultipla.do">
...
<br class="hidden" />
<div>
	<html:submit styleClass="submit" property="salvaAction" value="Riassegna la Posta" alt="Riassegna protocollo" />

...
<eprot:page title="Fatture">
<html:form action="/page/fatture/documento.do" enctype="multipart/form-data">
...
<logic:equal name="protocolloForm" property="flagTipo" value="R">
	<jsp:include page="/WEB-INF/subpages/protocollo/registroEmergenza/datiProtocolloEmergenzaIngresso.jsp" />
</logic:equal>
...
<bean:define id="sezioneVisualizzata" name="protocolloIngressoForm" property="sezioneVisualizzata" />
	...
	<logic:equal name="protocolloForm" property="protocolloId" value="0">
		<jsp:include page="/WEB-INF/subpages/protocollo/ingresso/link-sezioni.jsp" />
	</logic:equal>
	<logic:greaterThan name="protocolloForm" property="protocolloId" value="0">
	...
	<logic:match name="sezioneVisualizzata" value="Allegati" >
    	<jsp:include page="/WEB-INF/subpages/protocollo/fatture/allegati.jsp" />
	</logic:match>

...
<html:form action="/page/protocollo/ingresso/lavoratoProcedimento.do">
...
<logic:equal name="protocolloIngressoForm" property="documentoVisibile" value="true">
			<div class="sezione">
			<bean:define id="sezioneVisualizzata" name="protocolloIngressoForm" property="sezioneVisualizzata" /> <jsp:include
...
<html:submit styleClass="submit" property="btnLavoratoProcedimento" value="Salva" alt="Lavorato Procedimento" />
